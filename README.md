...
🛠️ Found a bug or have a suggestion? Open an issue here!
...
## ⚙️ Requirements:
- [Salesforce CLI ](https://developer.salesforce.com/tools/salesforcecli)must be installed and accessible. Configure the path in the plugin settings if needed.
- [IlluminatedCloud 2](https://plugins.jetbrains.com/plugin/10253-illuminated-cloud-2) is optional but required for the one-click debugger integration.
